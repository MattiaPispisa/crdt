...
class FugueTreeAppendBenchmark extends BenchmarkBase {
  FugueTreeAppendBenchmark()
      : super(
          'FugueTree append $_kElements elements',
...
class FugueTreePrependBenchmark extends BenchmarkBase {
  FugueTreePrependBenchmark()
      : super(
          'FugueTree prepend $_kElements elements',
          emitter: const CustomEmitter(),
        );
...
class FugueTreeRandomInsertBenchmark extends BenchmarkBase {
  FugueTreeRandomInsertBenchmark()
      : super(
          'FugueTree random insert $_kElements elements',
          emitter: const CustomEmitter(),
        );
...
class FugueTreeValuesBenchmark extends BenchmarkBase {
  FugueTreeValuesBenchmark()
      : super(
          'FugueTree values() over $_kElements live elements',
          emitter: const CustomEmitter(),
        );
...
class FugueTreeValuesWithTombstonesBenchmark extends BenchmarkBase {
  FugueTreeValuesWithTombstonesBenchmark()
      : super(
          'FugueTree values() over $_kElements elements, 90% tombstones',
          emitter: const CustomEmitter(),
        );
