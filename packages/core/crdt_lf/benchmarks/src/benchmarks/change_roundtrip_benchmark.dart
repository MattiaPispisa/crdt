...
class ChangeToBytesBenchmark extends TimedBenchmarkBase {
  ChangeToBytesBenchmark() : super('Change toBytes x1000');
...
class ChangeFromBytesBenchmark extends TimedBenchmarkBase {
  ChangeFromBytesBenchmark() : super('Change fromBytes x1000');
...
class ChangeRoundtripBenchmark extends TimedBenchmarkBase {
  ChangeRoundtripBenchmark() : super('Change roundtrip x1000');
