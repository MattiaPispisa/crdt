...
class DAGAddNodeChainBenchmark extends TimedBenchmarkBase {
  DAGAddNodeChainBenchmark() : super('DAG addNode chain of 1000');
...
class DAGGetAncestorsBenchmark extends TimedBenchmarkBase {
  DAGGetAncestorsBenchmark() : super('DAG getAncestors chain of 200');
