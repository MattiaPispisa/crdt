...
class VersionVectorToBytesBenchmark extends TimedBenchmarkBase {
  VersionVectorToBytesBenchmark()
      : super('VersionVector toBytes 10 peers x1000');
...
class VersionVectorFromBytesBenchmark extends TimedBenchmarkBase {
  VersionVectorFromBytesBenchmark()
      : super('VersionVector fromBytes 10 peers x1000');
...
class VersionVectorIntersectionBenchmark extends TimedBenchmarkBase {
  VersionVectorIntersectionBenchmark()
      : super('VersionVector intersection 10 peers x1000');
