...
class ImportChainBenchmark extends TimedBenchmarkBase {
  ImportChainBenchmark(this.count) : super('Import $count chained changes');
...
class ExportNewerThanBenchmark extends TimedBenchmarkBase {
...
class SnapshotPruneBenchmark extends TimedBenchmarkBase {
  SnapshotPruneBenchmark(this.count)
      : super('takeSnapshot(pruneHistory) with $count changes');
...
class ConcurrentFrontierPruneBenchmark extends TimedBenchmarkBase {
  ConcurrentFrontierPruneBenchmark(this.peers)
      : super('takeSnapshot(pruneHistory) with $peers concurrent heads');
