...
class NestedResolveBenchmark extends TimedBenchmarkBase {
  /// Creates a resolve benchmark for a tree with [width] leaves.
  NestedResolveBenchmark(this.width)
      : super('Resolve nested tree with $width leaves (cold caches)');
...
class NestedReconstructBenchmark extends TimedBenchmarkBase {
