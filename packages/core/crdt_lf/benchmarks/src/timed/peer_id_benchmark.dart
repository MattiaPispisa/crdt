...
class PeerIdGenerateBenchmark extends TimedBenchmarkBase {
  PeerIdGenerateBenchmark() : super('PeerId generate x100');
...
class PeerIdToBytesBenchmark extends TimedBenchmarkBase {
  PeerIdToBytesBenchmark() : super('PeerId toUint8List x1000');
...
class PeerIdFromBytesBenchmark extends TimedBenchmarkBase {
  PeerIdFromBytesBenchmark() : super('PeerId fromUint8List x1000');
