...
class CRDTDocument extends BaseCRDTDocument {
  ...
  ///
  /// The id is generated by the creator and carried inside the [HandlerRef], so
  /// remote peers reuse the same id verbatim when reconstructing the tree.
  String newHandlerId() => PeerId.generate().toString();
